...
public class ElementWiseMultiplicationNoSuperWord {
    ...
    public void vectors() {
        for (int i = 0; i < arraySize; i += SPECIES.length()) {
            ...
            FloatVector resultVector = aVector.mul(bVector);
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                .include(ElementWiseMultiplicationNoSuperWord.class.getSimpleName())
